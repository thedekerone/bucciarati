...
function Product(props) {
  ...
  return __jsx("div", {
    ...
    return __jsx("div", {
      ...
      __self: this
    }, props.data.title.toLowerCase()), __jsx("img", {
      onClick: e => {
