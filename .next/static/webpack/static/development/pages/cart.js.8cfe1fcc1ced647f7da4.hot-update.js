...
function Product(props) {
  ...
  return __jsx("div", {
    ...
    onChange: function onChange() {
      setCantidad(_babel_runtime_corejs2_core_js_parse_int__WEBPACK_IMPORTED_MODULE_0___default()(agregar.value) + 1);
