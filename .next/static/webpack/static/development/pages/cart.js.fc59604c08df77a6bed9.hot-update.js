...
function Boleta(_ref) {
  ...
  return __jsx("div", {
    ...
    __self: this
  }, "Boleta"), data.map(function (e, index) {
    return __jsx("li", {
      key: e.product._id,
