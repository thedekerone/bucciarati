...
function Carousel(props) {
  ...
  var styleNeeded = {
    ...
    whiteSpace: 'nowrap',
    margin: '0 auto',
    transition: immediate // display        : slides < 6 ? 'flex' : 'block',
