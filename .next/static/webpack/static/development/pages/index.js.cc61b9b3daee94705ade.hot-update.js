...
function Carousel(props) {
  ...
  var bind = Object(react_use_gesture__WEBPACK_IMPORTED_MODULE_6__["useDrag"])(function (_ref) {
    ...
    down ? Math.abs(delta[0]) < 1 ? setGaa(true) : setGaa(false) : setGaa(true);
    setImmediate(false);
    set({
